...
void DrawMenuScreen(Texture2D backgroundTex, Texture2D startBTNTex, Texture2D instructTex, Texture2D quitTex)
{
    ...
    // Draw Buttons, Shade gray if hovered
...
void DrawGameOverScreen(Texture2D gameOverTex, Texture2D resumeTex)
{
    ...
    // Draw resume button, shade gray if hovered
...
// Draw instructions screen with back to menu button
void DrawInstructionsScreen(Texture2D backgroundTex, Texture2D resumeTex)
{
    ...
    DrawText("INSTRUCTIONS", 475, 100, 40, YELLOW);  
    ...
    // Draw quit button, shade gray if hovered
    DrawTexturePro(resumeTex,
                    (Rectangle){0,0,resumeTex.width, resumeTex.height},
                    resumeDest,
                    (Vector2){0,0},
...
// Draw victory screen with back to menu button
void DrawVictoryScreen(Texture2D backgroundTex, Texture2D resumeTex)
{
    // Draw background
    DrawTexturePro(backgroundTex, 
                    (Rectangle){ 0, 0, (float)backgroundTex.width, (float)backgroundTex.height }, 
    ...
    // Draw victory text
    DrawText("CONGRATULATIONS!", SCREEN_WIDTH / 2 - 200, 200, 40, YELLOW);
    DrawText("You escaped the maze!", SCREEN_WIDTH / 2 - 110, 300, 20, RAYWHITE);
